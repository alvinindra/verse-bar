...
final class UpdateChecker {
    ...
    private let releasesAPI = URL(string: "https://api.github.com/repos/alvinindra/verse-bar/releases/latest")!
    /// Public releases page (opened when user clicks "Download").
    private let releasesPage = URL(string: "https://github.com/alvinindra/verse-bar/releases/latest")!
